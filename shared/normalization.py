"""Device name normalization utilities.

Provides consistent device name handling across Hub and Spoke.
Device names are normalized for routing while preserving display names.
"""
